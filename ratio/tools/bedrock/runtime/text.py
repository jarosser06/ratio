"""
Amazon Bedrock Text Tool

This tool invokes text generation models through Amazon Bedrock Converse API. It processes text prompts 
...
_FN_NAME = "ratio.tools.bedrock.text"
