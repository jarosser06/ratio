"""
Ratio Combine Content Agent Stack
"""
from os import path
...
class RatioCombineContentAgent(Stack):
    def __init__(self, app_name: str, app_base_image: str, architecture: str, deployment_id: str,
        ...
        self.agent_execute = EventBusSubscriptionFunction(
            ...
            construct_id="ratio-agent-combine-content-execution",
            event_type="ratio::agent::combine_content::execution",
            description="Ratio Combine Content Agent Execution Handler",
            entry=self.runtime_path,
            index="run.py",
            handler="handler",
            function_name=resource_namer("agent-combine-content", scope=self),
            memory_size=256,
