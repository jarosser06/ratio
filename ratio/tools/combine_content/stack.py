"""
Ratio Combine Content Tool Stack
"""
from os import path
...
class RatioCombineContentTool(Stack):
    def __init__(self, app_name: str, app_base_image: str, architecture: str, deployment_id: str,
        ...
        self.tool_execute = EventBusSubscriptionFunction(
            ...
            construct_id="ratio-tool-combine-content-execution",
            event_type="ratio::tool::combine_content::execution",
            description="Ratio Combine Content Tool Execution Handler",
            entry=self.runtime_path,
            index="run.py",
            handler="handler",
            function_name=resource_namer("tool-combine-content", scope=self),
            memory_size=256,
