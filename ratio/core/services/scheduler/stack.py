...
from ratio.core.services.scheduler.tables.subscriptions.stack import Subscription, SubscriptionsTableStack
    ...
    def __init__(self, app_name: str, app_base_image: str, architecture: str,
        ...
        self.scheduler_manager = SimpleRESTService(
            ...
            resource_access_requests=[
                ...
                ResourceAccessRequest(
                    resource_name=Subscription.table_name,
